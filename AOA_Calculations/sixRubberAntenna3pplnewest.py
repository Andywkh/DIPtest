...
from Dataloaders.apriltag_loader_v3 import *

# E280 1160 6000 0209 F811 48C3
# MAC0 = str(input("Please Input MAC Address 1"))

#MAC0 = "E280 1160 6000 0209 F811 5CA3" # RFID Tag 1 (John)
#MAC1 = "E280 1160 6000 0209 F811 5C93" # RFID Tag 2 (SiMin)
#MAC2 = "E280 1160 6000 0209 F811 5CD4" # RFID Tag 4 (Deva)
...
RFID_data_T1 = RFID_dataloader_v2('./Latest_Test/rfid/test2.csv',MAC0)
RFID_data_T2 = RFID_dataloader_v2('./Latest_Test/rfid/test2.csv',MAC1)
RFID_data_T3 = RFID_dataloader_v2('./Latest_Test/rfid/test2.csv',MAC2)
cv_data_T1 = cv_dataloader('./Latest_Test/gtcsv/v2_fairMOT results.txt',  box_list_wanted =['1'])### fill in later
cv_data_T2 = cv_dataloader('./Latest_Test/gtcsv/v2_fairMOT results.txt',  box_list_wanted =['2'])### fill in later
cv_data_T3 = cv_dataloader('./Latest_Test/gtcsv/v2_fairMOT results.txt',  box_list_wanted =['3'])### fill in later
...
def time_function(time_value, RFID_data):
    ...
    phase0_rad = data[0][0] + (1.09393272)
    phase1_rad = data[0][1] + (0.23077764)
    phase2_rad = data[0][2] + (-0.982696)
    phase3_rad = data[0][3] + (-0.40625833)
    phase4_rad = data[0][4] + (0.3992933)
    phase5_rad = data[0][5] + (-0.79960184)
