...
RFID_data_T1 = RFID_dataloader_v2('./Datasets/rfid/test3.csv',MAC0)
RFID_data_T2 = RFID_dataloader_v2('./Datasets/rfid/test3.csv',MAC1)
#RFID_data_T3 = RFID_dataloader_v2('./Datasets/rfid/test3.csv',MAC2)
cv_data_T1 = cv_dataloader('./Datasets/gtcsv_processed/test3.csv',  box_list_wanted =['1'])### fill in later
